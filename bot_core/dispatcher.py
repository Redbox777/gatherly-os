...
class Dispatcher:
    ...
    def process_update(self, update: dict):
        ...
        if chat_id in self.reminder_handler.states:
            self.reminder_handler.process_state(chat_id, text)
            return
